...
- Learn Elasticsearch, Kibana, Elastic PHP APM, logs, and browser error tracking with **Sentry** via [ELK_LEARNING_LAB.md](ELK_LEARNING_LAB.md) and [`docs/SENTRY_SELF_HOSTED.md`](docs/SENTRY_SELF_HOSTED.md).
