...
use App\Auth\LearningEmailActivator;
...
class Auth extends ShieldAuth
{
    ...
    public array $views = [
        ...
        'action_email_activate_show'  => 'portal/auth/email_activate_show',
    ...
    public array $actions = [
        'register' => LearningEmailActivator::class,
        'login'    => null,
    ];
    ...
    {
        $url = $this->redirects['force_reset'];
    ...
    {
        $url = $this->redirects['permission_denied'];
    ...
    {
        $url = $this->redirects['group_denied'];
