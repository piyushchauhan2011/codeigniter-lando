...
<section class="portal-card">
    ...
    <?php if ($profile['logo_path'] ?? null): ?>
        <p><img src="<?= esc(base_url('uploads/' . $profile['logo_path']), 'attr') ?>" alt="Logo" class="company-profile__logo"></p>
    <?php endif; ?>

    <form method="post" action="<?= portal_url('employer/profile') ?>" class="portal-form" enctype="multipart/form-data">
        <?= csrf_field() ?>
        ...
        <button type="submit" class="portal-button">Save profile</button>
    </form>
</section>
<?php $this->endSection(); ?>
