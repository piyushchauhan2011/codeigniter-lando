...
<section class="portal-card">
    ...
    <?php if (! empty($profile['resume_path'])): ?>
        <p class="portal-text-muted">Resume on file (stored securely).</p>
    <?php endif; ?>

    <form method="post" action="<?= portal_url('seeker/profile') ?>" class="portal-form" enctype="multipart/form-data">
        <?= csrf_field() ?>
