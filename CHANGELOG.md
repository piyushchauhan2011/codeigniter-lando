...
For older release notes by minor version, see the [CodeIgniter 4 changelog files in the upstream repository](https://github.com/codeigniter4/CodeIgniter4/tree/develop/changelogs).
